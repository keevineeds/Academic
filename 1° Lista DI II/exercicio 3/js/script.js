    ...
    criptografar(){
        switch (this.op){
            case 1:
                ...
                break;
            case 2:
                this.cr2 = this.msg.replace('T', '@').replace(/K/gi, '$').replace(/G/gi, '#').replace(/I/gi, '*').replace(/O/gi, '&')
